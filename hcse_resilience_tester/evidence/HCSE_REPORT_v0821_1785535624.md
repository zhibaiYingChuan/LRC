...
|-----------|------|--------|------|----------|------|
| INV-V0821-01 | wizard.json 兜底创建 | P0 | FAIL | 5015 | HTTPConnectionPool(host='127.0.0.1', port=3099): Read timed out. (read timeout=5 |
| INV-V0821-02 | 120s 自动启动超时保护 | P0 | FAIL | 5005 | HTTPConnectionPool(host='127.0.0.1', port=3099): Read timed out. (read timeout=5 |
| INV-V0821-03 | switch_project 120s 超时保护 | P0 | PASS | 0 | Tauri 桥接可用，switch_project 超时保护已就位 |
| INV-V0821-04 | 状态栏 lockBusy 紫色显示 | P1 | FAIL | 146 | lock-busy类=False, 后台合成中文本=False (故障注入:_lockBusy=true) |
| INV-V0821-05 | dao metrics 503 lock_busy 处理 | P1 | FAIL | 157 | 含'服务未启动'误报=False, 含'后台合成中'=False (故障注入) |
