...
> **历史资料说明**：本文档及其引用的结果属于 **v0.5.6（2026-06-23）历史基准测试**，用于查询和复现历史数据，不代表当前 v0.9.3 的性能结论。请勿删除；如需当前版本结果，应新增独立的 v0.9.3 基准报告并保留本文件。
...
>
> **版本说明（v0.9.3）**：本文档中的性能表和历史基准结果不是 v0.9.2 的重新实测结果。v0.9.2 修复了 ML 编码器塌缩和中文搜索崩溃；如需发布级性能结论，请使用当前版本重新执行本指南中的测试流程。
...
| :---: | :--- | :--- | :--- | :--- |
| 1 | MS MARCO | 关键词检索能力 | TF-IDF MRR=0.7749, LLM MRR=0.8895 | [报告](./LRC_MSMARCO_REPORT.md) |
| 2 | Natural Questions | 自然语言问题检索 | TF-IDF MRR=0.5389, LLM MRR=0.8016 | [报告](./LRC_NQ_REPORT.md) |
| 3 | HotpotQA | 多跳推理检索 | TF-IDF MRR=0.7964, LLM MRR=0.9383 | [报告](./LRC_HOTPOTQA_REPORT.md) |
| 4 | FiQA | 金融领域检索 | TF-IDF MRR=0.2729, LLM MRR=0.4453 | [报告](./LRC_FIQA_REPORT.md) |
| 5 | LRC 原生基准 | 综合记忆能力 | TF-IDF 11/11 PASS, 总评分 0.94 | [报告](./LRC_NATIVE_BENCHMARK_TFIDF.md) |
| 6 | LongMemEval | 长时记忆能力 | v3 公平 Session Recall@10=85.74% | [报告](./LRC_LONGMEMEVAL_REPORT.md) |
...
> 完整的 6 次基准测试汇总对比报告请参考 [LRC_BENCHMARK_SUMMARY.md](./LRC_BENCHMARK_SUMMARY.md)。
...
> 完整的 LongMemEval 公平对比报告请参考 [LRC_LONGMEMEVAL_REPORT.md](./LRC_LONGMEMEVAL_REPORT.md)。

---

## 基准测试方法论

如需了解 LRC 基准测试的设计哲学、测试维度和实现细节，请参考 [基准测试方法论白皮书](./BENCHMARK_METHODOLOGY.md)。
