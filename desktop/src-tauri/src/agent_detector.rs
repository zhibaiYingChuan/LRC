...
const KNOWN_TOOLS: &[KnownTool] = &[
    ...
    // Kimi Code / kCode — 月之暗面 Moonshot CLI 工具
    KnownTool {
        id: "kimi-code",
        name: "Kimi Code (kCode)",
        icon: "🌙",
        category: "cli",
        supports_mcp: true,
        primary_marker: ".kimi",
        secondary_markers: &[],
        mcp_config_template: Some(".kimi/settings.json"),
        mcp_transport: "stdio",
        binary_paths: &[],
        exe_names: &["kcode", "kimi-code", "kimi", "kimi-code.exe", "kcode.exe"],
    },
    // 通义灵码 Tongyi Lingma — 阿里巴巴 Alibaba IDE 插件
    KnownTool {
        id: "tongyi-lingma",
        name: "通义灵码 (Lingma)",
        icon: "🧞",
        ...
        mcp_transport: "stdio",
        binary_paths: &[],
        exe_names: &["lingma", "lingma.exe"],
    },
    // 文心快码 Comate — 百度 Baidu IDE 插件
    KnownTool {
        id: "comate",
        name: "文心快码 (Comate)",
        icon: "📘",
        ...
        mcp_transport: "stdio",
        binary_paths: &[],
        exe_names: &["comate", "comate.exe"],
    },
    // CodeGeeX — 智谱 AI / 清华大学 IDE 插件
    KnownTool {
        id: "codegeex",
        name: "CodeGeeX",
        icon: "🔬",
        ...
        mcp_transport: "stdio",
        binary_paths: &[],
        exe_names: &["codegeex", "codegeex.exe"],
    },
    // Fitten Code — 非十科技/清华团队 IDE 插件
    KnownTool {
        id: "fitten-code",
        name: "Fitten Code",
        icon: "⚡",
        category: "ai-assistant",
        supports_mcp: false,
        primary_marker: ".fitten",
        secondary_markers: &[],
        mcp_config_template: None,
        mcp_transport: "stdio",
        binary_paths: &[],
        exe_names: &["fitten-code", "fitten", "fitten-code.exe", "fitten.exe"],
    },
    // CodeFuse — 蚂蚁集团 Ant Group IDE 插件
    KnownTool {
        id: "codefuse",
        name: "CodeFuse",
        icon: "🐜",
        category: "ai-assistant",
        supports_mcp: false,
        primary_marker: ".codefuse",
        secondary_markers: &[],
        mcp_config_template: None,
        mcp_transport: "stdio",
        binary_paths: &[],
        exe_names: &["codefuse", "codefuse.exe"],
    },
    // CodeArts Snap — 华为云 Huawei Cloud IDE 插件
    KnownTool {
        id: "codearts-snap",
        name: "CodeArts Snap",
        icon: "☁️",
        category: "ai-assistant",
        supports_mcp: false,
        primary_marker: ".codearts",
        secondary_markers: &[],
        mcp_config_template: None,
        mcp_transport: "stdio",
        binary_paths: &[],
        exe_names: &["codearts-snap", "codearts", "codearts-snap.exe"],
    },
    // iFlyCode — 科大讯飞 iFlytek IDE 插件
    KnownTool {
        id: "iflycode",
        name: "iFlyCode",
        icon: "🎤",
        category: "ai-assistant",
        supports_mcp: false,
        primary_marker: ".iflycode",
        secondary_markers: &[],
        mcp_config_template: None,
        mcp_transport: "stdio",
        binary_paths: &[],
        exe_names: &["iflycode", "iflycode.exe"],
    },
    // MarsCode — 字节跳动 ByteDance IDE 插件
    KnownTool {
        id: "marscode",
        name: "MarsCode",
        icon: "🚀",
        ...
        mcp_transport: "stdio",
        binary_paths: &[],
        exe_names: &["marscode", "marscode.exe"],
    },
    // MiniMax Code — 稀宇科技 MiniMax CLI 工具
    KnownTool {
        id: "minimax-code",
        name: "MiniMax Code",
        icon: "🎯",
        category: "cli",
        supports_mcp: true,
        primary_marker: ".minimax",
        secondary_markers: &[],
        mcp_config_template: Some(".minimax/settings.json"),
        mcp_transport: "stdio",
        binary_paths: &[],
        exe_names: &["minimax-code", "minimax", "minimax-code.exe"],
    },
    // AIXcoder — 硅心科技 IDE 插件
    KnownTool {
        id: "aixcoder",
        name: "AIXcoder",
        icon: "🤖",
        category: "ai-assistant",
        supports_mcp: false,
        primary_marker: ".aixcoder",
        secondary_markers: &[],
        mcp_config_template: None,
        mcp_transport: "stdio",
        binary_paths: &[],
        exe_names: &["aixcoder", "aixcoder.exe"],
    },
    // Kilo Code — 开源 IDE 插件/CLI
    KnownTool {
        id: "kilo-code",
        name: "Kilo Code",
        icon: "⚖️",
        ...
        primary_marker: ".kilo",
        secondary_markers: &[],
        mcp_config_template: Some(".kilo/settings.json"),
        mcp_transport: "stdio",
        binary_paths: &[],
        exe_names: &["kilo-code", "kilo", "kilo-code.exe"],
    },
    // 腾讯云 AI 代码助手 — Tencent Cloud IDE 插件
    KnownTool {
        id: "tencent-ai-assistant",
        name: "腾讯云 AI 代码助手",
        icon: "☁️",
        category: "ai-assistant",
        supports_mcp: false,
        primary_marker: ".tencent-ai",
        secondary_markers: &[],
        mcp_config_template: None,
        mcp_transport: "stdio",
        binary_paths: &[],
        exe_names: &["tencent-ai-code", "tac", "tencent-ai-code.exe"],
    },
...
fn binary_exists(binary_paths: &[&str]) -> bool {
    binary_paths
        .iter()
        .any(|p| resolve_binary_path(p).is_some())
}
...
fn scan_exe_in_install_dirs(exe_names: &[&str]) -> bool {
    ...
    for root in &scan_roots {
        ...
        for entry in walkdir::WalkDir::new(root)
            .max_depth(3)
            .into_iter()
            .filter_entry(|e| e.path() == root || !is_scan_ignored_dir(e.path()))
            .filter_map(|e| e.ok())
        {
            let path = entry.path();
            if !path.is_file() {
            ...
            if let Some(file_name) = path.file_name().and_then(|n| n.to_str()) {
                ...
                #[cfg(target_os = "windows")]
                {
                    if targets.contains(&file_name_lower) {
                        tracing::debug!("[Agent检测] 匹配到可执行文件: {}", path.display());
                        return true;
                    }
                }
...
fn collect_install_dirs() -> Vec<PathBuf> {
    ...
    #[cfg(target_os = "windows")]
    {
        ...
        // Windows: 公共应用数据和 WindowsApps（商店安装的 AI 工具）
        if let Ok(program_data) = std::env::var("ProgramData") {
            dirs.push(PathBuf::from(&program_data));
        }
        if let Ok(local_appdata) = std::env::var("LOCALAPPDATA") {
            dirs.push(PathBuf::from(&local_appdata).join("Microsoft/WindowsApps"));
        }
    }
    ...
    dirs.retain(|dir| unique.insert(dir.to_string_lossy().to_lowercase()));
    dirs
}

/// 直接扫描 PATH 中的可执行文件，避免递归扫描 PATH 目录。
fn collect_path_exe_names() -> Vec<String> {
...
fn get_scan_cache() -> Arc<ScanCache> {
    ...
    let path_exe_names = collect_path_exe_names();
...
/// 判断快捷方式内容是否指向指定 Agent，使用工具显示名和可执行文件名。
fn shortcut_matches_agent(content: &[u8], executable: &str) -> bool {
    search_exe_in_lnk(content, &[executable.to_lowercase()])
}

/// 收集桌面和开始菜单中的快捷方式名称，供用户确认未知工具。
fn collect_shortcut_names() -> Vec<String> {
    let mut names: Vec<String> = Vec::new();
    for dir in collect_shortcut_dirs() {
        let Ok(entries) = std::fs::read_dir(dir) else {
            continue;
        };
        for entry in entries.flatten() {
    ...
    fn check_known_tool(&self) -> bool {
        ...
        if let Some(cache) = cache_opt.as_ref() {
            ...
            if cache
                .exe_names
                .iter()
                .chain(cache.path_exe_names.iter())
        ...
        // 自动展示严格以桌面/开始菜单快捷方式为准。
        // 安装目录、PATH 和固定路径只用于辅助信息，不能单独判定已安装。
        let installed = lnk_hit;
...
impl AgentDetector for DotDirDetector {
    ...
    fn config_path(&self) -> Option<PathBuf> {
        self.tool.mcp_config_template.and_then(resolve_marker)
...
impl AgentDetector for TraeDetector {
    fn detect(&self) -> bool {
        ...
        cache.lnk_contents.iter().any(|content| {
            !contains_trae_cn(content) && search_exe_in_lnk(content, &["trae.exe".to_string()])
        })
    }
...
impl AgentDetector for TraeCNDetector {
    fn detect(&self) -> bool {
        ...
        cache
            .lnk_contents
            .iter()
            .any(|content| search_exe_in_lnk(content, &["trae cn.exe".to_string()]))
    }
    ...
    fn detect(&self) -> bool {
        #[cfg(target_os = "windows")]
        {
            ...
            if cache
                .lnk_contents
                .iter()
                .any(|content| shortcut_matches_agent(content, "claude.exe"))
            {
                return true;
            }
            // Windows 端严格以桌面或开始菜单快捷方式作为自动确认依据。
        }
...
impl AgentDetectorRegistry {
    ...
    /// 检测所有已知 Agent，但只有桌面/开始菜单快捷方式能确认 installed=true。
    ...
    fn discover_unknown_tools(&self) -> Vec<AgentInfo> {
        ...
        if let Ok(entries) = std::fs::read_dir(&home) {
            for entry in entries.flatten() {
                ...
                // dot 目录只能作为配置线索，不能自动认定为 AI 工具或进入主列表。
                let _ = (has_mcp, has_config);
            }
        }

        // 未知工具只来自桌面/开始菜单快捷方式，不从 exe 名称或关键词推断。
        // 这些候选不会自动显示为 AI 工具，交给用户确认后再加入列表。
        for shortcut_name in collect_shortcut_names() {
            let id = format!(
                "shortcut-{}",
                shortcut_name.to_lowercase().replace([' ', '_'], "-")
            );
            if unknown.iter().any(|tool| tool.id == id) {
                continue;
            }
            unknown.push(AgentInfo {
                ...
                config_path: None,
                icon: "❓".into(),
                category: "shortcut-candidate".into(),
                supports_mcp: false,
            });
        }
    ...
    pub fn configure(
        ...
        if let Some(ref binary_path) = self.lrc_binary_path {
            ...
            tracing::warn!(
                "[MCP配置] LRC 二进制路径未设置，MCP 配置将使用 'lrc' 命令（需要 PATH 环境变量）"
            );
        }
        ...
        for id in agent_ids {
            if let Some(detector) = self.detectors.iter().find(|d| d.info().id == *id) {
                ...
                if let Some(path) = detector.config_path() {
                    ...
                    match self.write_or_merge_config(&path, &config) {
                        Ok(()) => {
                            ...
                            match Self::write_ai_rules(&info.id) {
                                Ok(()) => {
                                    tracing::info!("[AI规则] {} — 全局规则文件写入成功", info.name);
                                }
                                Err(e) => {
                    ...
                    tracing::info!(
                        "[MCP配置] {} — 无全局配置路径，需手动配置项目级 mcp.json",
                        info.name
                    );
                    configured.push(format!("{} — 请手动配置项目级 mcp.json", info.name));
                }
            } else {
    ...
    pub fn configure_all_installed(
        &self,
        port: u16,
        project_dir: Option<&std::path::Path>,
    ) -> Result<Vec<String>, String> {
    ...
    pub fn write_rules_for_agents(&self, agent_ids: &[String]) -> Result<Vec<String>, String> {
            ...
            if let Ok(existing_json) = serde_json::from_str::<serde_json::Value>(&existing_content)
            {
                if let (Some(existing_servers), Some(new_servers)) = (
                    ...
                    if let Some(obj) = merged.as_object_mut() {
                        let mut servers = existing_servers.as_object().cloned().unwrap_or_default();
    ...
    fn write_ai_rules(tool_id: &str) -> Result<(), String> {
        ...
        if let Some(parent) = rules_path.parent() {
            std::fs::create_dir_all(parent)
                .map_err(|e| format!("创建规则文件目录失败: {} ({})", parent.display(), e))?;
        }
        ...
        if rules_path.exists() {
            ...
            // 创建新文件
            std::fs::write(&rules_path, &lrc_rules)
                .map_err(|e| format!("创建规则文件失败: {} ({})", rules_path.display(), e))?;
            tracing::info!(
                "[AI规则] {} — 已创建全局规则文件 v{}: {}",
                tool_id,
                LRC_RULES_VERSION,
...
mod tests {
    ...
    fn test_compare_versions_less() {
        assert_eq!(
            compare_versions("0.5.12", "0.8.0"),
            std::cmp::Ordering::Less
        );
        assert_eq!(
            compare_versions("0.7.99", "0.8.0"),
            std::cmp::Ordering::Less
        );
    }
