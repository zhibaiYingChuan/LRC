...
impl CoreManager {
    pub fn new() -> Self {
        let terms = vec![
            ...
            "match", "loop", "for", "while", "if", "else", "mut", "ref", "move",
            "clone", "copy", "drop", "deref", "borrow", "crate", "super", "dyn",
            "where", "into", "from", "macro", "derive", "new", "static", "unsafe",
            "union", "use", "let", "const", "type", "self", "return", "true", "false",
            "some", "none", "ok", "err", "result", "option", "box", "arc", "rc",
            "cell", "mutex", "rwlock", "channel", "thread", "spawn",
            "tokio", "serde", "ownership", "lifetime", "concurrent", "parallel",
            // ==================== 通用编程关键词 ====================
            "def", "class", "function", "export", "import", "var", "interface",
            "abstract", "virtual", "override", "extends", "implements",
            "throw", "try", "catch", "finally", "yield", "pass", "break", "continue",
            "null", "nil", "void", "string", "number", "integer", "float", "boolean",
            "array", "list", "map", "hash", "set", "vector", "iterator", "collection",
            "input", "output", "file", "read", "write", "open", "close", "stream",
            "buffer", "parse", "serialize", "deserialize", "convert", "transform",
            "validate", "process", "execute", "invoke", "call", "send", "receive",
            "connect", "disconnect", "register", "unregister", "subscribe", "publish",
            "notify", "trigger", "listen", "watch", "observe", "monitor", "track",
            "create", "update", "delete", "remove", "insert", "find", "replace",
            "merge", "split", "sort", "filter", "group", "aggregate", "calculate",
            "compute", "generate", "apply", "resolve",
            // ==================== 机器学习 / AI ====================
            "loss", "gradient", "model", "training", "train", "inference", "evaluate",
            "accuracy", "epoch", "batch", "dataset", "optimizer", "learning_rate",
            "weight", "bias", "activation", "layer", "neural", "deep", "embedding",
            "token", "predict", "classify", "classification", "regression", "validate",
            "validation", "overfit", "underfit", "normalize", "softmax", "relu",
            "sigmoid", "tanh", "dropout", "backprop", "forward", "backward", "tensor",
            "feature", "label", "target", "metric", "f1", "precision", "recall",
            "attention", "transformer", "encoder", "decoder", "llama", "gpt", "bert",
            "diffusion", "generator", "discriminator", "latent", "sample", "reward",
            "policy", "agent", "state", "action", "value", "entropy", "log_prob",
            "likelihood", "prior", "posterior", "bayesian", "gaussian", "categorical",
            "vocabulary", "corpus", "similarity", "distance", "cosine",
            "euclidean", "cluster", "centroid", "pipeline", "preprocessing", "scaling",
            "augmentation", "prompt", "completion", "temperature", "top_p", "top_k",
            "sampling", "context", "reasoning", "chain", "thought", "alignment",
            "rlhf", "dpo", "ppo", "sft", "lora", "quantization", "distillation",
            "pruning", "gpu", "cuda", "fp16", "bf16", "int8", "int4", "torch",
            "tensorflow", "pytorch", "numpy", "pandas", "huggingface",
            // ==================== Web / HTTP ====================
            "request", "response", "header", "body", "status", "route", "router",
            "middleware", "cookie", "auth", "cors", "json", "xml", "get", "post",
            "put", "delete", "patch", "rest", "graphql", "websocket", "http", "api",
            "url", "uri", "endpoint", "payload", "ssl", "tls", "redirect", "proxy",
            "gateway", "rate_limit", "throttle", "timeout", "retry", "backoff",
            "health_check", "metric", "alert", "log", "span",
            // ==================== 数据库 / 存储 ====================
            "database", "db", "table", "column", "row", "query", "select", "join",
            "index", "primary", "foreign", "transaction", "commit", "rollback",
            "migrate", "schema", "sql", "redis", "postgres", "mysql", "mongodb",
            "sqlite", "pool", "connection", "cursor", "backup", "restore",
            "replication", "partition", "lock", "deadlock",
            // ==================== 测试 / 调试 ====================
            "test", "assert", "expect", "mock", "fixture", "stub", "integration",
            "unit", "coverage", "benchmark", "profile", "error", "warn", "info",
            "debug", "trace", "panic", "exception", "stack",
            // ==================== DevOps / 工具链 ====================
            "cargo", "npm", "pnpm", "yarn", "git", "commit", "push", "pull", "branch",
            "merge", "rebase", "deploy", "docker", "container", "ci", "cd", "pipeline",
            "yaml", "toml", "env", "environment", "build", "init", "setup", "cli",
            "release", "version", "package", "publish", "registry", "module",
            "plugin", "extension", "framework", "library", "workspace",
            // ==================== Loong 内部术语 ====================
            "memory", "retrieve", "encode", "decode", "search", "index", "session",
            "config", "user", "task", "workflow", "engine", "handler", "manager",
            "store", "cache", "query", "fetch", "load", "save", "recall", "remember",
            "forget", "luoshu", "bagua", "topology", "crystallize", "compose",
            "unfold", "reflect", "mirror", "evolution", "governance", "constitution",
        ];
